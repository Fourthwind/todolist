...
$(function (){
        ...
        var newstuffScript = $("#newstuff-template").html();
        var newstuffTemplate = Handlebars.compile(newstuffScript);
        var newstuffHTML = newstuffTemplate(wrapper);
        
        $('.main-container').html(newstuffHTML);
